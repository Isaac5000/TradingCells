...
import com.cosmocraft.trading_cells.platform.neoforge.mobfarm.MobFarmLootTables.DropSummary;
...
public final class MobFarmLootPreview {
    ...
    public record Analysis(Map<Identifier, DropSummary> drops, boolean complete) { }

    private MobFarmLootPreview(ServerLevel level, LootContext context, int looting) {
        this.level = level;
