...
/** Equipment column shared by mob-farm menus. */
public final class MobFarmEquipmentSlots {
    ...
    private MobFarmEquipmentSlots() {
    }

    public static List<Slot> create(Inventory inventory) {
        return List.of(
                armorSlot(inventory, EquipmentSlot.HEAD, 39, MobFarmMenuLayout.EQUIPMENT_HEAD_Y, EMPTY_HELMET),
                armorSlot(inventory, EquipmentSlot.CHEST, 38, MobFarmMenuLayout.EQUIPMENT_CHEST_Y, EMPTY_CHESTPLATE),
                armorSlot(inventory, EquipmentSlot.LEGS, 37, MobFarmMenuLayout.EQUIPMENT_LEGS_Y, EMPTY_LEGGINGS),
                armorSlot(inventory, EquipmentSlot.FEET, 36, MobFarmMenuLayout.EQUIPMENT_FEET_Y, EMPTY_BOOTS),
                new OffhandSlot(inventory)
        );
    }

    private static Slot armorSlot(
            Inventory inventory,
        ...
        return new ArmorSlot(
                ...
                equipmentSlot,
                inventorySlot,
                MobFarmMenuLayout.itemX(MobFarmMenuLayout.EQUIPMENT_X),
                MobFarmMenuLayout.itemY(frameY),
                emptyIcon
        );
    }

    private static Identifier emptyIcon(String path) {
    ...
    private static final class OffhandSlot extends Slot {
        ...
        private OffhandSlot(Inventory inventory) {
            super(
                    ...
                    40,
                    MobFarmMenuLayout.itemX(MobFarmMenuLayout.EQUIPMENT_X),
                    MobFarmMenuLayout.itemY(MobFarmMenuLayout.EQUIPMENT_OFFHAND_Y)
            );
