...
public final class ZombieFarmEnchantments {
    ...
    private ZombieFarmEnchantments() {
    }
    ...
    private static Entity createTarget(
        ...
        return switch (kind) {
            case ZOMBIE -> EntityTypes.ZOMBIE.create(level, EntitySpawnReason.LOAD);
            case ZOMBIE_VILLAGER -> EntityTypes.ZOMBIE_VILLAGER.create(level, EntitySpawnReason.LOAD);
            case HUSK -> EntityTypes.HUSK.create(level, EntitySpawnReason.LOAD);
            case DROWNED -> EntityTypes.DROWNED.create(level, EntitySpawnReason.LOAD);
            case ZOMBIFIED_PIGLIN -> EntityTypes.ZOMBIFIED_PIGLIN.create(level, EntitySpawnReason.LOAD);
            case ZOGLIN -> EntityTypes.ZOGLIN.create(level, EntitySpawnReason.LOAD);
        };
    }
