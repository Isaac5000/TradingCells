...
public final class ZombieFarmEquipmentSlots {
    ...
    private ZombieFarmEquipmentSlots() {
    }

    public static List<Slot> create(Inventory inventory) {
        return List.of(
                armorSlot(inventory, EquipmentSlot.HEAD, 39, ZombieFarmMenuLayout.EQUIPMENT_HEAD_Y, EMPTY_HELMET),
                armorSlot(inventory, EquipmentSlot.CHEST, 38, ZombieFarmMenuLayout.EQUIPMENT_CHEST_Y, EMPTY_CHESTPLATE),
                armorSlot(inventory, EquipmentSlot.LEGS, 37, ZombieFarmMenuLayout.EQUIPMENT_LEGS_Y, EMPTY_LEGGINGS),
                armorSlot(inventory, EquipmentSlot.FEET, 36, ZombieFarmMenuLayout.EQUIPMENT_FEET_Y, EMPTY_BOOTS),
    ...
    private static ArmorSlot armorSlot(
        ...
        return new ArmorSlot(
                ...
                equipmentSlot,
                inventorySlot,
                ZombieFarmMenuLayout.itemX(ZombieFarmMenuLayout.EQUIPMENT_X),
                ZombieFarmMenuLayout.itemY(frameY),
                emptyIcon
        );
    }
    ...
    private static final class OffhandSlot extends Slot {
        ...
        private OffhandSlot(Inventory inventory) {
            super(
                    ...
                    40,
                    ZombieFarmMenuLayout.itemX(ZombieFarmMenuLayout.EQUIPMENT_X),
                    ZombieFarmMenuLayout.itemY(ZombieFarmMenuLayout.EQUIPMENT_OFFHAND_Y)
            );
