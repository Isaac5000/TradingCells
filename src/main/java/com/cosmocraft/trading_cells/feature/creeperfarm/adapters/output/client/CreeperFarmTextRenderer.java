...
/** Draws translated Creeper Farm labels on one line, shrinking only when their container requires it. */
final class CreeperFarmTextRenderer {
    private CreeperFarmTextRenderer() {
    }
