...
public final class CreeperFarmScreenLayout {
    private static final Identifier BACKGROUND = Identifier.fromNamespaceAndPath(
            TradingCells.MOD_ID,
            "textures/gui/creeper_farm/background.png"
    );
    ...
    private CreeperFarmScreenLayout() {
    }
    ...
    public static void drawBackground(GuiGraphicsExtractor graphics, int left, int top) {
        graphics.blit(
                ...
                0.0F,
                0.0F,
                CreeperFarmMenuLayout.WIDTH,
                CreeperFarmMenuLayout.HEIGHT,
                CreeperFarmMenuLayout.ATLAS_WIDTH,
                CreeperFarmMenuLayout.ATLAS_HEIGHT
        );
    }
