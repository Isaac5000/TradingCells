package com.cosmocraft.trading_cells.feature.creeperfarm.adapters.output;

import com.cosmocraft.trading_cells.feature.creeperfarm.adapters.input.CreeperFarmBlock;
...
public final class CreeperFarmRegistrationAdapter {
    ...
    public static final DeferredBlock<CreeperFarmBlock> BLOCK = Registration.BLOCKS.register(ID, () ->
            new CreeperFarmBlock(MachineBlockProperties.villager(ID))
    );

    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<CreeperFarmBlockEntity>> BLOCK_ENTITY =
            Registration.BLOCK_ENTITY_TYPES.register(ID, () ->
                    new BlockEntityType<>(CreeperFarmBlockEntity::new, BLOCK.get())
            );
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<CreeperFarmMenu>> MENU =
            Registration.MENU_TYPES.register(ID, () ->
                    new MenuType<>(CreeperFarmMenu::new, FeatureFlags.VANILLA_SET)
            );
