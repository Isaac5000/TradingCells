...
public record RaiderFarmGuiThemeColors(
        int scrollTrack,
        int scrollThumbLight,
        SlotRenderer.Palette slotPalette
) {
    private static final RaiderFarmGuiThemeColors NEUTRAL = new RaiderFarmGuiThemeColors(
            0xFF555555,
            0xFFDADADA,
    ...
    public static RaiderFarmGuiThemeColors resolve() {
        return NEUTRAL;
    }
}
