package com.cosmocraft.trading_cells.feature.combat.adapters.output.client;
...
public final class StormShardItemRenderSupport {
    ...
    private static float animationTicks() {
        // Inventory screens can pause level time; the energy layer must keep moving there too.
    ...
    public record Unbaked() implements SpecialModelRenderer.Unbaked<ItemStack> {
        ...
        public SpecialModelRenderer<ItemStack> bake(
                SpecialModelRenderer.@NonNull BakingContext context
        ) {
