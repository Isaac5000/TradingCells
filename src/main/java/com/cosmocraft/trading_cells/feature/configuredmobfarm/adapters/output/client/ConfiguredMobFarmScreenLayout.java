...
public final class ConfiguredMobFarmScreenLayout {
    ...
    private ConfiguredMobFarmScreenLayout() {
    }
    ...
    public static void drawBackground(GuiGraphicsExtractor graphics, int left, int top) {
        graphics.blit(
                ...
                0.0F,
                0.0F,
                ConfiguredMobFarmMenuLayout.WIDTH,
                ConfiguredMobFarmMenuLayout.HEIGHT,
                ConfiguredMobFarmMenuLayout.ATLAS_WIDTH,
                ConfiguredMobFarmMenuLayout.ATLAS_HEIGHT
        );
    }
